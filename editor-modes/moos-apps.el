...
(setq moos-app-and-keyword-list
      ...
      '("pMissionEval" "lead_condition" "pass_condition" "fail_condition" "result_flag" "pass_flag" "fail_flag"  "max_appcast_events" "mission_form" "report_column" "report_file" "report_line_format" "mission_mod" "prereport_column")

      '("uFldDelv" "rate_frame")
      '("pGenRescue" "")
      '("iM300Health" "StaleTime" "MaxHeadingDelta" "LowBattThresh" "FullBattThresh" )

      '("pSpoofNode" "refresh_interval" "default_length" "default_vtype" "default_color" "default_group" "default_vsource" "default_duration" )
      ...
      '("pLLMAgent" "model" "api_key_env" "api_url" "max_tokens" "effort" "timeout" "max_retries" "max_tool_rounds" "refusal_fallback" "history_turns" "system_prompt" "system_prompt_file" "chat_in_var" "chat_out_var" "status_var" "chat_newline" "confirm_default" "vnames" "watch" "watch_all" "state_in_prompt" "stale_thresh" "bt_tree_var" "tool" "receivers" "standard_capabilities" "capability_dir" "capability_keep" "capability_drop" "teams" "members_var")
      '("pBehaviorTree" "tree_var" "tree_file_var" "cmd_var" "status_var" "active_var" "event_var" "log_var" "chat_var" "reply_var" "report_var" "signal_var" "members_var" "team" "vnames" "teams" "member_tree_var" "member_state_var" "member_cmd_var" "contacts" "contact_max_age" "contacts_publish" "autostart" "echo_posts" "max_events" "halt_flag" "fail_flag" "end_flag" "watch" "standard_capabilities" "capability_dir" "capability_keep" "capability_drop" "view" "view_prefix" "plan_view_color" "active_view_color" "success_view_color" "failure_view_color")
      ...
      '("uSimCurrent" "current_field" "wrap_data" "wrap_data_len" )
      ...
      '("pMediator" "resend_thresh" "max_tries" "mates" "no_ack_var" "group" "vname" )
